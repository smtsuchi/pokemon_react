...
export default function Auth({ setUser }) {
    ...
    let first_name, last_name, email, password, password2, mySVG, armL, armR, eyeL, eyeR, nose, mouth, mouthBG, mouthSmallBG, mouthMediumBG, mouthLargeBG, mouthMaskPath, mouthOutline, tooth, tongue, chin, face, eyebrow, outerEarL, outerEarR, earHairL, earHairR, hair;
    ...
    useEffect(() => {
        ...
        if (first_name){
            first_name.addEventListener('focus', onElemFocus);
            first_name.addEventListener('blur', onElemBlur);
            first_name.addEventListener('input', onElemInput);
            last_name.addEventListener('focus', onElemFocus);
            last_name.addEventListener('blur', onElemBlur);
            last_name.addEventListener('input', onElemInput);
      ...
      return () => {
        ...
        if (first_name){
            first_name.removeEventListener('focus', onElemFocus);
            first_name.removeEventListener('blur', onElemBlur);
            first_name.removeEventListener('input', onElemInput);
            last_name.removeEventListener('focus', onElemFocus);
            last_name.removeEventListener('blur', onElemBlur);
            last_name.removeEventListener('input', onElemInput);
    ...
    return (
        ...
        <div className='auth-container no-select'>
            <img src={PokemonLogo} alt='Coding Summit Logo'></img>
